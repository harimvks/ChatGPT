...
class ContextBuilderBase(ABC):
    """Reusable bounded/deterministic context-builder contract."""
    ...
    def payload_fields(self) -> Mapping[str, object]:
        """Return already-resolved, JSON-serializable domain data."""
        ...
    ...
    def build(
        self, *, context_id: str, target_type: str, target_ref: str, created_at: datetime
    ) -> ContextManifest:
